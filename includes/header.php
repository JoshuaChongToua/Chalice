    ...
    <div class="nano">
        <div class="nano-content">
            ...
            <ul>
                ...
                <li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i>  Users  <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
                        <li><a href="users.php">Liste Users</a></li>
                        <li><a href="users.php?action=create">Add User</a></li>
                    </ul>
                </li><li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i>  News  <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
                        <li><a href="news.php">Liste News</a></li>
                        <li><a href="news.php?action=create">Add News</a></li>
                    </ul>
                </li><li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i>  Types  <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
                        <li><a href="types.php">Liste Types</a></li>
                        <li><a href="types.php?action=create">Add Type</a></li>
                    </ul>
                </li><li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i>  Images  <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
